****************************************************************
               Welcome to SQLAPI++ Library 5.0.3
****************************************************************
...
-- Oracle: Fixed SAConnection::isConnected method returns true even if a long connection procedure fails later in another thread (thanks 
Jason Formby).
